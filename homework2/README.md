...
The `ExpandableArrayQueue` class provides a queue data structure with the following methods:
...
The `ExpandableArrayStack` class provides a stack data structure with the following methods:
